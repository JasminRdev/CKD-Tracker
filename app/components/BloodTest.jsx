...
export default function UploadExtractSave() {
  ...
  console.log(linesArray)
    ...
    linesArray.forEach((e) => {
        ...
        if(e.includes("MCH") && !e.includes("MCHC")) {
